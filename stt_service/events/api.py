...
def build_app(settings: Settings, bus: EventBus, pipeline: RuntimePipeline | None = None) -> FastAPI:
    app = FastAPI(title="Realtime STT Service", version="0.3.0")
    ...
    async def ws_events(websocket: WebSocket) -> None:
        ...
        try:
            ...
            if init.get("op") == "subscribe":
                ...
                from_line = init.get("cursor_line")
                for event in replay.from_cursor(from_event_id=from_event_id, from_line=from_line):
